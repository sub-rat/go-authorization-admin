...
export type CustomerServiceGetApiV1CustomersDefaultResponse = Awaited<ReturnType<typeof CustomerService.getApiV1Customers>>;
export type CustomerServiceGetApiV1CustomersQueryResult<TData = CustomerServiceGetApiV1CustomersDefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useCustomerServiceGetApiV1CustomersKey = "CustomerServiceGetApiV1Customers";
/**
 * Customer Query
 */
export const useCustomerServiceGetApiV1Customers = <TData = CustomerServiceGetApiV1CustomersDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ address, current, direction, fullName, key, pageSize, queryValue }: {
    address?: string;
    current?: number;
    direction?: "ASC" | "DESC";
    fullName?: string;
    ...
    pageSize?: number;
    queryValue?: string;
}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn" | "initialData">) => useQuery<TData, TError>({ queryKey: [useCustomerServiceGetApiV1CustomersKey, ...(queryKey ?? [{ address, current, direction, fullName, key, pageSize, queryValue }])], queryFn: () => CustomerService.getApiV1Customers(address, current, direction, fullName, key, pageSize, queryValue) as TData, ...options });
export type CustomerServicePostApiV1CustomersMutationResult = Awaited<ReturnType<typeof CustomerService.postApiV1Customers>>;
/**
 * Customer Create
 */
export const useCustomerServicePostApiV1Customers = <TData = CustomerServicePostApiV1CustomersMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
    data: dto_CustomerCreate;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
    data: dto_CustomerCreate;
}, TContext>({ mutationFn: ({ data }) => CustomerService.postApiV1Customers(data) as unknown as Promise<TData>, ...options });
export type CustomerServiceGetApiV1Customers1DefaultResponse = Awaited<ReturnType<typeof CustomerService.getApiV1Customers1>>;
export type CustomerServiceGetApiV1Customers1QueryResult<TData = CustomerServiceGetApiV1Customers1DefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useCustomerServiceGetApiV1Customers1Key = "CustomerServiceGetApiV1Customers1";
/**
 * Customer Get By ID
 */
export const useCustomerServiceGetApiV1Customers1 = <TData = CustomerServiceGetApiV1Customers1DefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ id }: {
    id: string;
}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn" | "initialData">) => useQuery<TData, TError>({ queryKey: [useCustomerServiceGetApiV1Customers1Key, ...(queryKey ?? [{ id }])], queryFn: () => CustomerService.getApiV1Customers1(id) as TData, ...options });
export type CustomerServicePutApiV1CustomersMutationResult = Awaited<ReturnType<typeof CustomerService.putApiV1Customers>>;
/**
 * Customer Update By ID
 */
export const useCustomerServicePutApiV1Customers = <TData = CustomerServicePutApiV1CustomersMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
    id: string;
    data: models_Customer;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
    id: string;
    data: models_Customer;
}, TContext>({ mutationFn: ({ id, data }) => CustomerService.putApiV1Customers(id, data) as unknown as Promise<TData>, ...options });
export type CustomerServiceDeleteApiV1CustomersMutationResult = Awaited<ReturnType<typeof CustomerService.deleteApiV1Customers>>;
/**
 * Customer Delete By ID
 */
export const useCustomerServiceDeleteApiV1Customers = <TData = CustomerServiceDeleteApiV1CustomersMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
    id: string;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
    id: string;
}, TContext>({ mutationFn: ({ id }) => CustomerService.deleteApiV1Customers(id) as unknown as Promise<TData>, ...options });
export type AstrologerServiceGetApiV1AstrologersDefaultResponse = Awaited<ReturnType<typeof AstrologerService.getApiV1Astrologers>>;
export type AstrologerServiceGetApiV1AstrologersQueryResult<TData = AstrologerServiceGetApiV1AstrologersDefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useAstrologerServiceGetApiV1AstrologersKey = "AstrologerServiceGetApiV1Astrologers";
/**
 * Astrologer Query
 */
export const useAstrologerServiceGetApiV1Astrologers = <TData = AstrologerServiceGetApiV1AstrologersDefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ address, current, direction, fullName, key, pageSize, queryValue }: {
    address?: string;
    current?: number;
    direction?: "ASC" | "DESC";
    fullName?: string;
    ...
    pageSize?: number;
    queryValue?: string;
}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn" | "initialData">) => useQuery<TData, TError>({ queryKey: [useAstrologerServiceGetApiV1AstrologersKey, ...(queryKey ?? [{ address, current, direction, fullName, key, pageSize, queryValue }])], queryFn: () => AstrologerService.getApiV1Astrologers(address, current, direction, fullName, key, pageSize, queryValue) as TData, ...options });
export type AstrologerServicePostApiV1AstrologersMutationResult = Awaited<ReturnType<typeof AstrologerService.postApiV1Astrologers>>;
/**
 * Astrologer Create
 */
export const useAstrologerServicePostApiV1Astrologers = <TData = AstrologerServicePostApiV1AstrologersMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
    data: dto_AstrologerCreate;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
    data: dto_AstrologerCreate;
}, TContext>({ mutationFn: ({ data }) => AstrologerService.postApiV1Astrologers(data) as unknown as Promise<TData>, ...options });
export type AstrologerServiceGetApiV1Astrologers1DefaultResponse = Awaited<ReturnType<typeof AstrologerService.getApiV1Astrologers1>>;
export type AstrologerServiceGetApiV1Astrologers1QueryResult<TData = AstrologerServiceGetApiV1Astrologers1DefaultResponse, TError = unknown> = UseQueryResult<TData, TError>;
export const useAstrologerServiceGetApiV1Astrologers1Key = "AstrologerServiceGetApiV1Astrologers1";
/**
 * Astrologer Get By ID
 */
export const useAstrologerServiceGetApiV1Astrologers1 = <TData = AstrologerServiceGetApiV1Astrologers1DefaultResponse, TError = unknown, TQueryKey extends Array<unknown> = unknown[]>({ id }: {
    id: string;
}, queryKey?: TQueryKey, options?: Omit<UseQueryOptions<TData, TError>, "queryKey" | "queryFn" | "initialData">) => useQuery<TData, TError>({ queryKey: [useAstrologerServiceGetApiV1Astrologers1Key, ...(queryKey ?? [{ id }])], queryFn: () => AstrologerService.getApiV1Astrologers1(id) as TData, ...options });
export type AstrologerServicePutApiV1AstrologersMutationResult = Awaited<ReturnType<typeof AstrologerService.putApiV1Astrologers>>;
/**
 * Astrologer Update By ID
 */
export const useAstrologerServicePutApiV1Astrologers = <TData = AstrologerServicePutApiV1AstrologersMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
    id: string;
    data: models_Astrologer;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
    id: string;
    data: models_Astrologer;
}, TContext>({ mutationFn: ({ id, data }) => AstrologerService.putApiV1Astrologers(id, data) as unknown as Promise<TData>, ...options });
export type AstrologerServiceDeleteApiV1AstrologersMutationResult = Awaited<ReturnType<typeof AstrologerService.deleteApiV1Astrologers>>;
/**
 * Astrologer Delete By ID
 */
export const useAstrologerServiceDeleteApiV1Astrologers = <TData = AstrologerServiceDeleteApiV1AstrologersMutationResult, TError = unknown, TContext = unknown>(options?: Omit<UseMutationOptions<TData, TError, {
    id: string;
}, TContext>, "mutationFn">) => useMutation<TData, TError, {
    id: string;
}, TContext>({ mutationFn: ({ id }) => AstrologerService.deleteApiV1Astrologers(id) as unknown as Promise<TData>, ...options });
